...
//
//@Disabled
//@TeleOp(name = "[Competition] New Turret DriveCode", group = "Robot")
//public class DriveCodeWithTurret extends OpMode {
//
//    // Driver Code
...
//            } else {
//                // ===== TARGET LOST =====
//                turret.setMotorPower(0);   // always stop open-loop first
//
//                if (wasTargetFoundLastFrame) {
//                    targetLostTimer.reset();
//                    wasTargetFoundLastFrame = false;
...
//
//                if (targetLostTimer.seconds() >= TARGET_LOST_DELAY) {
//                    // Go back to home using RUN_TO_POSITION
//                    turret.rotateToPosition(0);
//
//                } else {
//                    telemetry.addData("Target lost, waiting",
//                            "%.1f sec", TARGET_LOST_DELAY - targetLostTimer.seconds());
//                }
//            }
//        }
//
