...
public class PathingActions {
    ...
    public static class firingSequence implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket telemetryPacket) {
            ...
            telemetry.addData("Current RPM: ", flywheels.returnWheelVelocity());
            ...
            if (flywheels.returnWheelVelocity() < targetRPM*0.75) {
            ...
            if (shotsFired > 3) {
                flywheels.maintainFlywheelSpeed(targetRPM);
    ...
    public static class firingSequenceWithTrapdoorAndBelt implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket telemetryPacket) {
            ...
            // Wait for flywheels to reach speed
            if (flywheels.returnWheelVelocity() < targetRPM) {
                intake.stopIntake();
                belt.stopBelt();
                return true;   // keep waiting
            }
