...
@Disabled
public class AutoAimTurretControllerWithLocalization {
    ...
    public AutoAimTurretControllerWithLocalization(HardwareMap hardwareMap) {
...
//        double heading = pos.getHeading(AngleUnit.RADIANS);
        ...
        if (!localized){
            ...
            if (targetFound) {
                ...
                resetPose = new Pose2d(55-toInches(autoAim.xpos), 59-toInches(autoAim.ypos), RobotPose.heading.toDouble()); //autoAim.botAngleThing+Math.toRadians(desiredTag.ftcPose.bearing)
                drive = new MecanumDrive(hMap, resetPose);
